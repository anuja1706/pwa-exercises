...
module.exports = {
    app: {
        ...
        commerceAPI: {
            ...
            parameters: {
                clientId: '671952d5-c47c-4b2f-aba7-2fc4f1d68e16',
                organizationId: 'f_ecom_zzrb_029',
                shortCode: 'kv7kzm78',
                siteId: 'RefArch'
            },
            ocapi: {
                ...
                ocapi_clientId: 'ce75fb42-f2c8-4b49-8cf4-438c414ebee6',
                ocapi_clientPwd: 'P@Yza9GY#25t@g',
                api_version: 'v22_8'
            }
        },
        // Einstein api config
    ...
    ssrParameters: {
        ...
        proxyConfigs: [
            ...
            {
                host: 'zzrb-029.sandbox.us03.dx.commercecloud.salesforce.com',
                path: 'ocapi'
            },
            {
